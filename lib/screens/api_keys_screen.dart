...
class ApiKeyService {
  ...
  static String generateApiKey() {
    ...
    return "sk_${base64Url.encode(values)}".replaceAll(
      RegExp(r"[^a-zA-Z0-9]"),
      "",
    );
  }
...
//                           child: Column(
//                             children: [
//                               const Text('No API keys yet').semiBold(),
//                               const SizedBox(height: 4),
//                               const Text(
//                                 'Create your first API key to get started.',
//                               ).muted().small(),
...
//                                 buildHeaderCell("Key"),
//                                 buildHeaderCell("Created"),
//                                 buildHeaderCell("Last Used"),
...
//     return 'sk_' + values.map((b) => chars[b % chars.length]).join('');
//   }
